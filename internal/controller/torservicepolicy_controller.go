...
// TorServicePolicyReconciler reconciles a TorServicePolicy object
type TorServicePolicyReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

// +kubebuilder:rbac:groups=policy.torgateway.io,resources=torservicepolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=policy.torgateway.io,resources=torservicepolicies/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=policy.torgateway.io,resources=torservicepolicies/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the TorServicePolicy object against the actual cluster state, and then
