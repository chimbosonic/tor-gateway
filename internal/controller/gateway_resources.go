...
// ConfigMap. When testingNetworkInclude is non-empty it is spliced verbatim
// into the rendered torrc before the HiddenService block — used only by the
// chutney e2e harness; empty in production.
