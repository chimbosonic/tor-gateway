...
// OnionBalancePolicyReconciler reconciles a OnionBalancePolicy object
type OnionBalancePolicyReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

// +kubebuilder:rbac:groups=policy.torgateway.io,resources=onionbalancepolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=policy.torgateway.io,resources=onionbalancepolicies/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=policy.torgateway.io,resources=onionbalancepolicies/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the OnionBalancePolicy object against the actual cluster state, and then
